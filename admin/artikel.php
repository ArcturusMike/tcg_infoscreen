...
<?php
    ...
    $artikel_dauer_file = fopen("../../dateien/artikel_dauer.txt", "w") or die("Unable to open file!");
    fwrite($artikel_dauer_file, $artikel_dauer);
    fclose($artikel_dauer_file);

    // Write content to artikel file
    $artikel_links_file = fopen("../../dateien/artikel.txt", "w") or die("Unable to open file!");
